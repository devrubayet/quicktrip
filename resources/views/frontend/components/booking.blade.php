...
.booking-tabs {
    ...
    padding: 6px 10px;
    position: relative;
    z-index: 2; /* keep it above the box */
}
...
.search-box {
    background: #fff;
    border-radius: 20px;
    padding: 35px 40px 80px;  /* extra bottom space for overlapping button */
    max-width: 1150px;
    position: relative;
    margin: -35px auto 0;     /* pull up so tab overlaps and center horizontally */
    z-index: 1;
...
.search-btn {
    ...
    left: 50%;
    bottom: -30px;                 /* overlap outside the box */
